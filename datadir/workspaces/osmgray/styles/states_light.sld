  ...
  <sld:NamedLayer>
    ...
    <sld:UserStyle>
      ...
      <sld:FeatureTypeStyle>
          ...
          <sld:TextSymbolizer>
            <sld:Label>
              <ogc:Function name="strToUpperCase">
                <ogc:PropertyName>NAME_ENGL</ogc:PropertyName>
              </ogc:Function>
            </sld:Label>
            <sld:Font>
            ...
            <sld:LabelPlacement>
              <sld:PointPlacement>
                <sld:AnchorPoint>
                  ...
                  <sld:AnchorPointY>1.5</sld:AnchorPointY>
                </sld:AnchorPoint>
              </sld:PointPlacement>
            </sld:LabelPlacement>
            <sld:Halo>
            ...
            <sld:Fill>
              <sld:CssParameter name="fill">#3d3d3d</sld:CssParameter>
            </sld:Fill>
            <sld:Priority>
        ...
        <sld:VendorOption name="sortBy">POP</sld:VendorOption>
      </sld:FeatureTypeStyle>
    </sld:UserStyle>
  </sld:NamedLayer>
