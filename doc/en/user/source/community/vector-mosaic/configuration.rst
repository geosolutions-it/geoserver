...
Property Collectors
~~~~~~~~~~~~~~~~~~~
VectorMosaic supports an extensible mechanism of PropertyCollectors, providing functionality analogous to the ImageMosaic property collectors used for raster granules.
