...
public class HeadContent {
    ...
    @XmlElement(name = "map-title", namespace = "http://www.w3.org/1999/xhtml")
    protected String title;

    @XmlElement(name = "map-base", namespace = "http://www.w3.org/1999/xhtml")
    protected Base base;

    @XmlElement(name = "map-meta", type = Meta.class, namespace = "http://www.w3.org/1999/xhtml")
