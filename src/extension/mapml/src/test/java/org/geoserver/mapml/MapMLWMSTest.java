...
public class MapMLWMSTest extends MapMLTestSupport {
    ...
    public void testMapMLViewerPreviewLocationHTMLCBMTILE() throws Exception {
        ...
        String viewerLon = viewer.attr("lon");
        assertTrue(
                "Viewer lat should equal centre of bounds of input layer",
                "51.99727285576844".equalsIgnoreCase(viewerLat));
        assertTrue("Viewer lon should equal centre bounds of input layer", "0.0".equalsIgnoreCase(viewerLon));
    }
