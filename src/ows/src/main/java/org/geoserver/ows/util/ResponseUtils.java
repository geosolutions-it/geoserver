...
/**
    ...
    /**
     * Writes <CODE>string</CODE> into writer, escaping &, ', ", <, and > with the XML excape strings.
     */
     ...
     * <p>
     * This method checks <code>url</code> to see if the appended query string requires a '?' or '&' to be prepended.
     * </p>
     * <p>
     ...
     * <p>
     * If the url does not have a query string compopnent, the empty string is returned.
     * </p>
     * 
     * @param url The url.
     * 
