...
public class RemoteTestProcess implements GSProcess {
    ...
    public String execute(final ProgressListener progressListener) throws ProcessException {
    	return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
    			...
    			+ "				<store>"
    			+ "					<url>file:/D:/tmp/OAA_temp/6beb3206af66f6c8274cf888e85b2b81_e845371bd131ec4d737b6d619187d208/waypoints_6beb3206af66f6c8274cf888e85b2b81_e845371bd131ec4d737b6d619187d208.csv</url>"
    			+ "				</store>"
    			+ "			</item>"
...
//    			+ "			</item>"
    			...
    			+ "				  <host>172.21.64.40</host>"
    	        + "				  <port>5432</port>"
    	        + "				  <schema>geoserver</schema>"
    	        + "				  <database>geoserver</database>"
    	        + "				  <user>geoserver</user>"
    	        + "				  <passwd>hellasFORever</passwd>"
    			+ "				</store>"
    			+ "			</item>"
    			+ "		</translateContext>"
    			+ "	</resource>"
