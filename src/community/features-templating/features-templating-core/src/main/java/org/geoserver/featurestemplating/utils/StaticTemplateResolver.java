...
/**
 * This class is used to resolve static templates. It is used to resolve templates that are not
 * dynamic and do not require any processing or features collection evaluation. It will collect all
 * the $${} expressions and replace them with the ECQL resolved expression result from GeoTools
 * ECQL.toExpression method expression creation and evaluation, returning the final placeholders
...
public final class StaticTemplateResolver {
     ...
     * @throws IllegalArgumentException if the templateContent is null or invalid expressions are
     *     found.
     */
    ...
    private static int processExpression(
            String templateContent, StringBuilder resolvedContent, int expressionStart) {
