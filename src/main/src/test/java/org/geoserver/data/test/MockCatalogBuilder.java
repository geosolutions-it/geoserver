...
public class MockCatalogBuilder {
    ...
    public MockCatalogBuilder featureType(final String name, String srs, ProjectionPolicy projPolicy, 
        ...
        initResource(ft, FeatureTypeInfo.class, ftId, name, ds, ns, srs, projPolicy, envelope, 
            latLonEnvelope);
    ...
    public MockCatalogBuilder coverage(QName qName, String fileName, String srs, Class scope) {
        ...
        initResource(c, CoverageInfo.class, cId, name, cs, ns, srs, real.getProjectionPolicy(), 
    ...
    <T extends ResourceInfo> void initResource(T r, Class<T> clazz, String rId, String name, 
        StoreInfo s, NamespaceInfo ns, String srs, ProjectionPolicy projPolicy, 
        ReferencedEnvelope envelope, ReferencedEnvelope latLonEnvelope) {
        ...
        expect(catalog.getResourceByName(
            new NameImpl(ns.getURI(), name), ResourceInfo.class)).andReturn(r).anyTimes();

        expect(catalog.getResourceByName(ns, name,clazz)).andReturn(r).andReturn(r).anyTimes();
        expect(catalog.getResourceByName(ns, name,ResourceInfo.class)).andReturn(r).andReturn(r)
            .anyTimes();
    ...
    public MockCatalogBuilder layerGroup(String name, 
        List<String> layerNames, List<String> styleNames) {
        ...
        if (!featureTypes.isEmpty() || !coverages.isEmpty()) {
            if (!featureTypes.isEmpty()) {
                ...
                expect(catalog.getResourcesByStore(ds, ResourceInfo.class))
                    .andReturn((List)featureTypes).anyTimes();
            ...
            if (!coverages.isEmpty()) {
                ...
                expect(catalog.getResourcesByStore(cs, ResourceInfo.class))
                    .andReturn((List)coverages).anyTimes();
